...
function preload() {
  ...
  var i;
  for (i = 1; i <= 60="" _numscoresounds;="" i++)="" {="" loadaudio('score'="" +="" i,="" _baseurl="" 'sounds="" score'="" i);="" }="" for="" (i="1;" i="" <="_numHurtSounds;" loadaudio('hurt'="" hurt'="" function="" o()="" return="" _opening="" *="" ((_score=""> 50 ? 50 : 50 - _score) / 50);
}
...
function doInitSounds(result, keyPrefix, l) {
  for (var i = 1; i <= l;="" i++)="" {="" result.push(_game.add.audio(keyprefix="" +="" i));="" }="" function="" initsounds()="" doinitsounds(_scoresounds,="" 'score',="" _numscoresounds);="" doinitsounds(_hurtsounds,="" 'hurt',="" _numhurtsounds);="" _flapsound="_game.add.audio('flap'," 0.5);="" _bgm="_game.add.audio('bgm'," _bgm.onstop.add(function()="" if="" (_playbgm)="" _bgm.play();="" });="" randomplaysound(list,="" count)="" var="" sound;="" (count="=" 1)="" sound="list[0];" sound.play();="" else=""> 1) {
